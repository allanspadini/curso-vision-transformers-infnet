  ...
  return (
    <footer className="slide-footer">
      ...
      <div className="footer-center">
        <div
          className="footer-shortcut-hint"
          title="Clique ou pressione N para abrir as Falas do Apresentador"
        ...
        <div
          className="footer-shortcut-hint"
          title="Clique ou pressione G para visão geral dos slides"
        ...
        <div
          className="footer-shortcut-hint"
          title="Clique ou pressione F para tela cheia"
          onClick={onToggleFullscreen}
          style={{ cursor: 'pointer' }}
        >
          <span className="footer-kbd">F</span> Tela Cheia
        </div>
        <div className="footer-shortcut-hint" title="Use as setas ou espaço para navegar">
