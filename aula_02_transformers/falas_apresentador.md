...
## Disciplina: Visão Computacional com CNNs e Transformers — Aula 2
**Tema Central:** *Tudo o Que Você Precisa É de Atenção: Tokenização BPE, Self-Attention e o Bloco Transformer Completo*  
**Professor:** Prof. Allan Spadini  
**Instituição:** Faculdade Infnet — Pós-Graduação EAD  

---

### Slide 1: Visão Computacional com CNNs e Transformers — Aula 2
**Tipo:** `title`  
**Título:** Visão Computacional com CNNs e Transformers — Aula 2  
**Falas do Apresentador:**
> Olá a todos e sejam muito bem-vindos à nossa Aula 2 da disciplina de Visão Computacional com CNNs e Transformers!
>
...
### Slide 2: Recapitulação: A Anatomia da Segmentação Semântica
**Tipo:** `visual-component`  
**Título:** Recapitulação: A Anatomia da Segmentação Semântica  
**Falas do Apresentador:**
> Para começarmos, vamos honrar o tópico pendente da Aula 1: a arquitetura da Segmentação Semântica.
>
...
### Slide 3: O Paradigma da Completação: Previsão do Próximo Token
**Tipo:** `visual-component`  
**Título:** O Paradigma da Completação: Previsão do Próximo Token  
**Falas do Apresentador:**
> Vamos entrar agora no núcleo dos Transformers compreendendo o grande paradigma que move toda a inteligência artificial moderna: a Predição Autorregressiva do Próximo Token.
>
...
### Slide 4: O Pipeline Completo de Processamento em Transformers
**Tipo:** `card-grid`  
**Título:** O Pipeline Completo de Processamento em Transformers  
**Falas do Apresentador:**
> Antes de mergulharmos nas fórmulas matemáticas de cada etapa, vamos olhar o mapa completo da montanha que escalaremos hoje. O processamento de um Transformer é estruturado em 4 grandes fases consecutivas:
>
...
### Slide 5: Tokenização Subword: O Algoritmo Byte-Pair Encoding (BPE)
**Tipo:** `visual-component`  
**Título:** Tokenização Subword: O Algoritmo Byte-Pair Encoding (BPE)  
**Falas do Apresentador:**
> Como uma rede neural só entende números e tensores, precisamos de uma forma de converter texto em números. Historicamente, tínhamos dois extremos ruins:
...
### Slide 6: Laboratório Interativo 1: Explorador de Tokenização BPE
**Tipo:** `interactive`  
**Título:** Laboratório Interativo 1: Explorador de Tokenização BPE  
**Falas do Apresentador:**
> Chegamos ao nosso primeiro Laboratório Interativo! Convido todos a experimentarem na tela.
>
...
**Tipo:** `visual-component`  
**Título:** O Que São Embeddings? Do One-Hot ao Hiperespaço Semântico  
**Falas do Apresentador:**
> Uma das dúvidas mais frequentes quando começamos a estudar Transformers é: afinal, como transformamos palavras ou tokens em embeddings? Isso é feito por um modelo separado? E como a rede consegue capturar a relação entre palavras de significado próximo?
>
...
**Tipo:** `visual-component`  
**Título:** A Matriz Look-up Table e o Tensor 3D de Saída  
**Falas do Apresentador:**
> Agora que compreendemos a teoria e a geometria dos embeddings semânticos, vamos ver como essa camada opera na prática dentro da arquitetura Transformer.
>
...
**Tipo:** `visual-component`  
**Título:** Janela de Contexto: Quantidade de Tokens por Solicitação  
**Falas do Apresentador:**
> Com a matriz de embeddings compreendida, chegamos a um conceito central no ecossistema de LLMs e Transformers: a Janela de Contexto (Context Window).
>
...
**Tipo:** `visual-component`  
**Título:** Mapa da Arquitetura: Onde Estamos na Rede Transformer?  
**Falas do Apresentador:**
> Antes de mergulharmos no coração matemático do Transformer, vamos fazer uma pausa estratégica para olhar o mapa completo da arquitetura de Vaswani et al. (2017) e nos localizarmos na jornada.
>
...
**Tipo:** `visual-component`  
**Título:** Injeção de Posição: A Soma de Token Embedding + Position Embedding  
**Falas do Apresentador:**
> Vejamos por que a injeção de posição é indispensável antes de qualquer cálculo de atenção:
>
...
**Tipo:** `comparison`  
**Título:** Comparativo: Encodings Senoidais vs Embeddings Aprendidos  
**Falas do Apresentador:**
> Neste comparativo, detalhamos as duas grandes escolas de codificação posicional:
>
...
### Slide 13: O Mecanismo de Atenção: Dimensões e a Matriz de Similaridade (6 × 6)
**Tipo:** `visual-component`  
**Título:** O Mecanismo de Atenção: Dimensões e a Matriz de Similaridade (6 × 6)  
**Falas do Apresentador:**
> Chegamos ao coração do Scaled Dot-Product Attention: vamos entender como as matrizes Q e K interagem dimensionalmente para calcular a atenção entre todas as palavras!
>
...
**Tipo:** `visual-component`  
**Título:** Understanding Attention: A Matemática do Scaled Dot-Product  
**Falas do Apresentador:**
> Vamos agora formalizar matematicamente cada etapa da fórmula do Scaled Dot-Product Attention:
...
**Tipo:** `interactive`  
**Título:** Laboratório Interativo 2: Simulador Matemático de Scaled Dot-Product  
**Falas do Apresentador:**
> Neste segundo Laboratório Interativo, vocês podem manipular as matrizes reais do Scaled Dot-Product com tokens da nossa canção: ['Tudo', 'precisa', 'é', 'amor'].
>
...
**Tipo:** `visual-component`  
**Título:** Visualizing Attention: A Matriz de Atenção em Ação  
**Falas do Apresentador:**
> Uma das características mais fascinantes dos Transformers é a sua interpretabilidade visual através das Matrizes de Atenção (Attention Heatmaps).
>
...
### Slide 17: Tornando a Atenção Treinável: As Matrizes de Projeção W_Q, W_K, W_V
**Tipo:** `visual-component`  
**Título:** Tornando a Atenção Treinável: As Matrizes de Projeção W_Q, W_K, W_V  
**Falas do Apresentador:**
> Até agora, falamos de Q, K e V conceitualmente. Mas de onde eles surgem na prática?
>
...
### Slide 18: Causal Masking: Atenção Autorregressiva Sem Vazamento de Futuro
**Tipo:** `visual-component`  
**Título:** Causal Masking: Atenção Autorregressiva Sem Vazamento de Futuro  
**Falas do Apresentador:**
> Vamos entender agora o truque de engenharia que viabiliza o treinamento massivo de LLMs modernos na GPU: a Máscara Causal.
>
...
**Tipo:** `visual-component`  
**Título:** Multi-Head Attention: Múltiplos Subespaços de Representação  
**Falas do Apresentador:**
> Por que usamos Múltiplas Cabeças de Atenção (Multi-Head Attention) em vez de uma única cabeça grande?
>
...
### Slide 20: Laboratório Interativo 3: Inspetor Visual de Multi-Head Attention
**Tipo:** `interactive`  
**Título:** Laboratório Interativo 3: Inspetor Visual de Multi-Head Attention  
**Falas do Apresentador:**
> Neste terceiro Laboratório Interativo, vamos inspecionar as cabeças de atenção especializadas sobre um dos versos mais ricos da música:
...
### Slide 21: A Arquitetura Original para Tradução: Encoder-Decoder
**Tipo:** `visual-component`  
**Título:** A Arquitetura Original para Tradução: Encoder-Decoder  
**Falas do Apresentador:**
> Agora que dominamos a atenção autorregressiva e a máscara causal, vamos conhecer a macro-arquitetura seminal concebida no artigo de 2017 ('Attention Is All You Need') para a tarefa de Tradução Automática (Seq2Seq).
>
...
### Slide 22: Variantes da Atenção: Cross-Attention, FlashAttention e Eficiência
**Tipo:** `visual-component`  
**Título:** Variantes da Atenção: Cross-Attention, FlashAttention e Eficiência  
**Falas do Apresentador:**
> Conforme o campo evoluiu, surgiram variantes cruciais do mecanismo de atenção:
>
...
**Tipo:** `visual-component`  
**Título:** A Anatomia do Bloco Transformer: MHA, MLP, Residuais e LayerNorm  
**Falas do Apresentador:**
> Agora que dominamos a atenção, vamos analisar o Bloco Transformer completo — a unidade modular fundamental que será empilhada dezenas de vezes.
>
...
### Slide 24: O Transformer Tudo Junto: Macro-Arquitetura de Ponta a Ponta
**Tipo:** `visual-component`  
**Título:** O Transformer Tudo Junto: Macro-Arquitetura de Ponta a Ponta  
**Falas do Apresentador:**
> Vamos agora contemplar a Macro-Arquitetura Completa de ponta a ponta no fluxo de treinamento Supervisionado (Seq2Seq):
>
...
### Slide 25: Laboratório Interativo 4: Simulador de Parâmetros e Complexidade
**Tipo:** `interactive`  
**Título:** Laboratório Interativo 4: Simulador de Parâmetros e Complexidade  
**Falas do Apresentador:**
> No nosso quarto laboratório, vocês têm em mãos um simulador completo de engenharia de hardware e parâmetros para modelos baseados em Transformers (GPT-2, BERT, Vaswani 2017).
>
...
### Slide 26: Laboratório Interativo 5: Quiz de Fixação de Conhecimentos
**Tipo:** `interactive`  
**Título:** Laboratório Interativo 5: Quiz de Fixação de Conhecimentos  
**Falas do Apresentador:**
> Chegou a hora de testarmos a fixação de todo o conteúdo da aula de hoje em nosso Quiz Interativo de encerramento!
>
